...
from tasks.diabeticlocal_task import DiabeticTask
from tasks.fl.fl_task import FederatedLearningTask


class DiabeticFedTask(FederatedLearningTask, DiabeticTask):
    ...
    def sample_dirichlet_train_data(self, no_participants, alpha=0.9):
        ...
        cifar_classes = {0:[], 1:[], 2:[], 3:[], 4:[], 5:[]}
        for ind, x in tqdm(enumerate(self.train_dataset)):
            _, label, _ = x
